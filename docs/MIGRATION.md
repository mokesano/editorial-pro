# Panduan Migrasi OJS 2.x ke ScholarEdge 1.0

Panduan lengkap untuk melakukan migrasi dari Open Journal Systems (OJS) 2.x ke ScholarEdge 1.0.
...
ScholarEdge 1.0 adalah hasil refactoring total dari OJS 2.x dengan perubahan fundamental:
