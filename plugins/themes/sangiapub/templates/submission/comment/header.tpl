...
<body id="core-{$pageTitle|replace:'.':'-'}" class="popup">
...
<header>
    <img loading="lazy" src="{$baseUrl}/assets/img/wizdam-branded.svg" alt="Editorial Pro Systems" width="auto">
</header>
<div id="container">
	<nav>
		<div id="navbar"><a {if $currentJournal}href="{url journal=$currentJournal->getPath()}"{else}href="{$baseUrl}"{/if}>{$siteTitle}</a></div>
	</nav>
<div id="body">
<div id="main">
